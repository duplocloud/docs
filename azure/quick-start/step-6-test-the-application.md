...
2. Finish by deleting the **NONPROD** Infrastructure. In the DuploCloud Portal, navigate to **Administrator** -> **Infrastructure**. Click the **Action** menu icon (<img src="../../.gitbook/assets/image (4) (5).png" alt="" data-size="line">) for the **NONPROD** row and select **Delete**.&#x20;
