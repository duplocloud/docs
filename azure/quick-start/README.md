...
1. [Create Azure Infrastructure](../../aws/quick-start/step-1-infrastructure.md)
2. [Create a Tenant](../../aws/quick-start/step-2-tenant.md)
3. [Create a VM Host](step-3-create-vm-host.md)
