...
{% hint style="info" %}
**NOTICE:** This document provides frequently asked questions related to the high level architecture and business model. For more detailed technical FAQ please refer to the [AWS FAQ](https://docs.duplocloud.com/docs/v/aws/faq) or [Azure FAQ](https://docs.duplocloud.com/docs/v/azure/faq)&#x20;
{% endhint %}
