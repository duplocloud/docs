...
* AWS
  ...
  * [Set a delivery delay for SQS Queues](../aws-user-guide/aws-services/sqs-queue.md#creating-a-standard-queue), using increments of seconds.
  * Configure [Vanta compliance controls](../aws-user-guide/security-configuration-settings/vanta-compliance-controls.md) for DuploCloud Tenants.
  * Support for [OpenSearch storage options](../aws-user-guide/aws-services/elasticsearch.md).
  * [Security Configurations Settings](../aws-user-guide/security-configuration-settings/) documentation section added.
* GCP
  * [GKE Standard mode](../gcp-user-guide/use-cases/disaster-recovery/creating-gke-standard-service.md) is supported when creating DuploCloud Infrastructures.
  * Support for [Firestore ](../gcp-user-guide/gcp-services/firestore-database.md)databases.
  * Support for [GCP Hosts](../gcp-user-guide/use-cases/hosts-vms.md#id-3-toc-title) and [GCE VMs](../gcp-user-guide/use-cases/hosts-vms.md#gce-vm).
  * Create [Node Pools](../gcp-user-guide/gcp-services/node-pools.md) with support for accelerators and taints.
...
* AWS
  * Enable [Spot Instances](../aws-user-guide/use-cases/hosts-vms/auto-scaling/auto-scaling-groups/spot-instances.md) for EKS Autoscaling Groups (ASG).
...
* Azure
  * Create a [MySQL Flexible Serve](../azure-user-guide/azure-services/databases/mysql-flexible-server.md)r managed database service.
  * Add an [Azure Service Bus](../azure-user-guide/azure-services/service-bus.md).
* Kubernetes
  * [Follow logs](../aws-user-guide/aws-services/containers/eks-containers-and-services.md#kubernetes-containers) for K8s containers in real-time.&#x20;
...
* AWS
  * [Hibernate an EC2](../aws-user-guide/use-cases/hosts-vms/hibernate-an-ec2-host.md) host instance.
  * Display [Taints in ECS hosts on unreachable Nodes](../aws-user-guide/use-cases/hosts-vms/display-tainted-ec2-hosts.md).

## June 2023 and July 2023

* AWS
  * Manage [Tenant expiration and Tenant session durations](../aws-user-guide/use-cases/tenant-environment/tenant-session-duration.md).
  ...
  * Access [ECS container task shells](../aws-user-guide/prerequisites/kubectl-shell.md#view-the-ecs-task-shell) directly from the DuploCloud Portal.
  * Ability to designate [Essential Containers](../aws-user-guide/aws-services/containers/#7-toc-title-2) in Task definitions for ECS Services.
  * [Automate fault healing](../aws-user-guide/use-cases/faults-and-alarms/automatic-fault-healing.md) on EC2 Hosts that fail a status check.
  * Enhanced support for [Startup Probes](../aws-user-guide/aws-services/setting-up-probes.md).
* GCP
  * Support for [Redis database instances](../gcp-user-guide/gcp-services/managed-redis.md).
...
* AWS
  * [Enable EKS endpoints](../aws-user-guide/use-cases/disaster-recovery/kubernetes-cluster/enable-eks-endpoints.md) in a DuploCloud Infrastructure, in a more cost-effective and secure manner. Enabling endpoints in DuploCloud allows your network communication to remain internal to the network, without using NAT gateways.&#x20;
  * [Multiple containers](../aws-user-guide/aws-services/containers/#7-toc-title) are now supported in the ECS **Task Definitions** tab.
...
* Azure
  * Support for [Redis databases](../azure-user-guide/azure-services/databases/redis-database.md) is available.
* GCP
  * [Cloud Armour](../gcp-user-guide/gcp-services/cloud-armour.md) is supported, to monitor your cloud infrastructures and deployed applications against cyber-attacks.
...
* AWS
  * [Virtual Private Cloud (VPC) peering](../aws-user-guide/aws-services/virtual-private-cloud-vpc-peering.md) is supported to facilitate data transfer between VPCs.
  * [EMR Serverless](../aws-user-guide/aws-services/emr-serverless.md) is supported to run open-source big data analytics frameworks without configuring, managing, and scaling clusters or servers.
  * DuploCloud users can obtain [Just-In-Time (JIT) access](../aws-user-guide/use-cases/jit-access.md) to the AWS Console.
  * [AWS SQS Standard and FIFO queues](../aws-user-guide/aws-services/sqs-queue.md) are now supported.
  * Use the DuploCloud Portal to work with AWS [Internet of Things (IoT)](../aws-user-guide/aws-services/iot-internet-of-things.md).
  * Support for [Redis database versions](../aws-user-guide/aws-services/database/elastic-cache.md) when creating Elastic Cache (Ecache).
  * Enable [shell access for ECS, Kubernetes, and Native docke](../aws-user-guide/prerequisites/kubectl-shell.md)r containers using a simplified workflow.
  * Reduce storage cost and increase performance by [setting GP3 as your default storage class](../aws-user-guide/aws-services/storage/gp3-storage-class.md).
  * Enable [NAT Gateways for High Availability (HA)](../aws-user-guide/aws-services/nat-gateway-for-ha.md).
  * [Restart up to twenty DuploCloud Services](../aws-user-guide/aws-services/containers/#7-toc-title-1) at once.
* GCP
...
* Azure
  ...
  * Monitor Tenant usage in the [Cost Management for billing ](../azure-user-guide/use-cases/cost-management.md)feature with weekly or monthly views.
  * Edit [Azure agent pools](../azure-user-guide/azure-services/agent-pool.md#editing-an-agent-pool), used to run Azure Kubernetes (AKS) workloads.
* GCP
  * Monitor Tenant usage in the [Cost Management for billing](../gcp-user-guide/use-cases/cost-management/) feature with weekly or monthly views.&#x20;
* Kubernetes (K8s)
  ...
  * [Force creation of StatefulSets in AWS](../aws-user-guide/aws-services/containers/#5-toc-title).
  * Use the K8s Admin dashboard to [monitor StatefulSets in AWS](../aws-user-guide/use-cases/monitoring/kubernetes-administrator-dashboard.md).
  * Edit [Azure agent pools](../azure-user-guide/azure-services/agent-pool.md#editing-an-agent-pool), used to run Azure Kubernetes (AKS) workloads.
...
* [Support for adding Kubernetes Storage Class:](../aws-user-guide/aws-services/storage/adding-k8s-storage-class.md) Support for Kubernetes Storage Class and Persistent Volumes is now available.
* [Support for Kubernetes Secret Provider Class](../kubernetes-user-guide/configs-and-secrets/adding-secretproviderclass-custom-resource.md): This provides the ability to integrate AWS parameters and secrets to be available as Kubernetes secrets.
* [Ability to add Lambda using Container Images](../aws-user-guide/aws-services/lambda/create-lambda-using-container-image.md): Users can now configure an AWS Lambda using Container images.
