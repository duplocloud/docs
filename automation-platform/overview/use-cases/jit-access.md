...
Access AWS Console using the Console link from your user profile page, or a specific resource page. To access the AWS Console from a specific resource page, see the [AWS Console link](using-aws-console.md).
...
Use this pattern in CICD pipelines and other places where a human won't be present to click approve in the interactive prompt. You'll need an [API token](../../access-control/api-and-session-management/api-tokens.md).
...
<div align="left"><figure><img src="../../../.gitbook/assets/admin_jit_screenshot.png" alt="" width="405"><figcaption></figcaption></figure></div>
