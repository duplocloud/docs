...
2.  From the **Name** column, select the Tenant for which you want to configure an expiration time.<br>
...
3.  From the **Actions** list box, select **Set Tenant Expiration**. The **Tenant - Set Tenant Expiration** pane displays. <br>
