...
1.  In the DuploCloud Portal's **Tenant** list box, select **dev01**.<br>
    ...
    <div align="left"><figure><img src="../../../../.gitbook/assets/tenant_dev01.png" alt=""><figcaption><p>DuploCloud <strong>Tenant</strong> list box with <strong>dev01</strong> selected</p></figcaption></figure></div>
