...
7.  From the **Docker Networks** list box, select **Docker Default**.<br>
    ...
    <figure><img src="../../../../.gitbook/assets/Screenshot (122).png" alt=""><figcaption><p>The <strong>Add Service</strong> page</p></figcaption></figure>
...
{% hint style="info" %}
Once the Service is **Running**, you can check the logs for additional information. On the **Services** page, select the **Containers** tab, click the menu icon ( <img src="../../../../.gitbook/assets/Kabab_three_Vertical_dots.png" alt="" data-size="line"> ) next to the container name, and select **Logs**.
{% endhint %}
