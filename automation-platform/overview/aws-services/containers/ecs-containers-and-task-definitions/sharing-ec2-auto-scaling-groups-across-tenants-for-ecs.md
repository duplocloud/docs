...
1. [Create an ECS Task Definition](../../../../../aws-user-guide/aws-services/containers/ecs-containers-and-task-definitions.md#creating-a-task-definition).&#x20;
   * In the **Launch Type** field, select **EC2**.
2. Using this task definition, [create an ECS Service](../../../../../aws-user-guide/aws-services/containers/ecs-containers-and-task-definitions.md#creating-an-ecs-service).&#x20;
