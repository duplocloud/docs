---
description: Access compliance reports directly from the DuploCloud Portal
---
...
1. In the upper-right corner of the DuploCloud Portal, click the **Trust Center** icon (<img src="../../.gitbook/assets/Screenshot (844).png" alt="" data-size="line">).
2.  Click **Compliance Reports**. The **Compliance Reports** page displays a list of available reports.<br>

    <div align="left"><figure><img src="../../.gitbook/assets/Screenshot (846).png" alt=""><figcaption><p><strong>Compliance Reports</strong> page</p></figcaption></figure></div>
