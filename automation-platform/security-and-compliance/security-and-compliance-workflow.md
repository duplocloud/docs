...
Choose a Governance, Risk, and Compliance (GRC) tool such as Vanta, Thoropass, or Drata. This step is optional but highly recommended. For more information about using GRC tools with DuploCloud, see the [DuploCloud documentation](grc-tools-and-duplocloud.md).
