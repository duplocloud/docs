...
* [Management Portal Scope](../../introduction/application-focused-interface-duplocloud-architecture/management-portal-scope.md)**:** Learn how each DuploCloud portal defines the environment and resources users can access.
