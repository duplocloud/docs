...
4. In the **Key** field, select one of the following:&#x20;
   * **new\_user\_email\_subject**: to customize the subject line.
   * **new\_user\_email\_body**:  to customize the email body.
...
2.  Click **Add**. The **Add Config** pane displays.<br>
    ...
    <div align="left"><figure><img src="../../../.gitbook/assets/Screenshot (379).png" alt=""><figcaption><p>The <strong>Add Config</strong> pane</p></figcaption></figure></div>
3. Complete the fields as shown in the table below:

<table data-header-hidden><thead><tr><th width="150.888916015625"></th><th></th></tr></thead><tbody><tr><td><strong>Config Type</strong></td><td>Select <strong>Flags</strong></td></tr><tr><td><strong>Key</strong></td><td>Select <strong>Enable new admin notification</strong></td></tr><tr><td><strong>Value</strong></td><td>Select <strong>true</strong> to enable email notifications for new admin users.</td></tr></tbody></table>
...
2.  Click **Add**. The **Add Config** pane displays.<br>
    ...
    <div align="left"><figure><img src="../../../.gitbook/assets/Screenshot (469).png" alt=""><figcaption><p>The <strong>Add Config</strong> pane</p></figcaption></figure></div>
3. Complete the fields as shown in the table below:
