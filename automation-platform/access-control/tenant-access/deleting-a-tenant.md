...
5.  Select the **Enable** switch to disable **Delete protection** for the Tenant.<br>

    <div align="left"><figure><img src="../../../.gitbook/assets/delt_en.png" alt=""><figcaption><p><strong>Update Tenant Feature</strong> pane with <strong>Delete protection</strong> not enabled</p></figcaption></figure></div>
