...
{% content-ref url="../../access-control/api-and-session-management/api-tokens.md" %}
[api-tokens.md](../../access-control/api-and-session-management/api-tokens.md)
{% endcontent-ref %}

1. **(Recommended)** Create a "service account" user in DuploCloud to own the API token.
2. Give the DuploCloud user access to the desired Tenant. See [adding Tenants to a user](../../access-control/user-access-and-permissions/tenant-access/#adding-tenant-access-for-a-user).
