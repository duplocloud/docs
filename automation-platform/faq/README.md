...
Although the onboarding process can take thirty to seventy (30-70) hours, DuploCloud staff performs about 90% of the work. Contact [DuploCloud Support](../../getting-started/duplocloud-support-model.md) with any additional questions.
...
### Am I locked into DuploCloud? What work must I do to move away from it?
...
The best strategy for your organization will ultimately depend on your specific compliance needs and priorities. To learn more about the differences between compliance support offered by traditional GRC tools like Vanta or Drata and DuploCloud, see the [DuploCloud documentation](../security-and-compliance/grc-tools-and-duplocloud.md) on this topic.
