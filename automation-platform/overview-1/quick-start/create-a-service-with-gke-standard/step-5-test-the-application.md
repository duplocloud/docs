...
4. In the **LB Configuration** card, click the Copy Icon ( <img src="../../../../.gitbook/assets/copy_icon.png" alt="" data-size="line"> ) to copy the **IP Address** displayed to your clipboard.
