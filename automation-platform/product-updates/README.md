...
* AWS – RDS: Global system setting to hide the RDS master password .<sup>1</sup>
* Kubernetes – : 1.35 Support — Add support for EKS 1.35, cluster autoscaler 1.35, and GKE 1.35.<sup>1</sup>
* AWS – ASG: Mixed Instances Policy — Add support for multiple instance types per ASG.<sup>1</sup>
* AWS – RDS: Add storage autoscaling support for RDS read replicas.<sup>1</sup>
* GCP : Custom Backend Config Support.<sup>1</sup>
* Access Management – [Keycloak Integration](../access-control/#keycloak-integration) — Integrate external identity providers via Keycloak.²
* AWS – [Target Groups: Lambda Target Type](../overview/aws-services/load-balancers/target-groups.md) — Add Lambda functions as targets for ALBs.²
* AWS –[ ElastiCache Serverless: Valkey](../overview/aws-services/database/elastic-cache.md#creating-a-serverless-valkey-elasticache-instance) — Support for ElastiCache Serverless clusters.¹<sup>,</sup>²
* AWS – [Headless Aurora DB Cluster](../overview/aws-services/database/rds-database/aurora-global-database.md#using-headless-aurora-clusters) — Provision and manage headless Aurora clusters.²
* Azure -[ Maintenance Schedules](../overview-2/use-cases/azure-maintenance-schedules.md) — Configure Azure Maintenance Schedules within DuploCloud.¹
* General - [Profile Page API Tokens](../access-control/api-and-session-management/api-tokens.md#creating-a-permanent-api-token-from-the-profile-page) — Create personal API tokens from the user Profile page.¹
* Azure - [Container Apps support](../overview-2/azure-services/azure-container-apps.md) — Provision and manage Azure Container Apps.¹<sup>,</sup>²
* AWS - [ECS Task Placement Strategy](../../overview/aws-services/containers/ecs-containers-and-task-definitions/) — Enable binpacking/task placement strategies for ECS.²
* Azure - [Security Standard](../overview-2/azure-security-standards.md) — Apply and manage Azure Security Standard configurations.¹
* AWS - [Customize Auto Alerts](../overview/use-cases/faults-and-alarms/automatic-alert-creation.md) — Configure custom alert thresholds for AWS resources.¹
* Azure - [Storage Account: Anonymous Blob Access](../overview-2/azure-services/storage-account.md) — Enable anonymous blob access.²
* AWS - [CloudFront Functions and KeyStore](../overview/aws-services/cloudfront/) — Provision CloudFront Functions and KeyStores.¹<sup>,</sup>²
* Azure - [VM Disk Support](../../overview-2/use-cases/hosts-vms/) — Manage Azure VM disks via DuploCloud.²
* AI Suite - [SRE Master Agent](/broken/pages/DGneE26z6b6HzAAzYofV#site-reliability-engineer-sre-agent) — Use the SRE Master AI Agent for automated DevOps operations.²
* CI/CD - [GitHub Actions Self-Hosted Runners](../introduction-to-ci-cd/github-actions/self-hosted-runners.md) — Provision self-hosted GitHub Actions runners.¹<sup>,</sup>²
* GCP - [GKE Node Pool Scaling](../overview-1/gcp-services/node-pools.md#adding-a-node-pool) — Support scaling node pools down to zero.¹<sup>,</sup>²
* AWS - [Aurora Global Database](../overview/aws-services/database/rds-database/aurora-global-database.md) — Support for globally distributed Aurora clusters.²
* Kubernetes – [Image Update API](../kubernetes-overview/initcontainers-and-sidecar-containers.md) — Support image updates for additional and initContainers.¹<sup>,</sup>²
* AWS - [ElastiCache Snapshot Retention](../overview/aws-services/database/elastic-cache.md#updating-snapshot-retention-limit) — Configure snapshot retention limits.¹
* Cost Management - [Custom Resource Tagging](../../overview/use-cases/custom-resource-tags.md) — Apply custom tags to cloud resources.¹<sup>,</sup>²
* Security & Compliance - [Compliance Documents](../security-and-compliance/compliance-reports.md) — Download DuploCloud compliance reports._¹_
* AWS - [ECS Run Task](../../overview/aws-services/containers/ecs-containers-and-task-definitions/#running-a-task-optional) — Allow selecting a capacity provider strategy when running ECS tasks.¹<sup>,</sup>²
...
* Kubernetes - [K8s secrets & ConfigMaps backup](../kubernetes-overview/configs-and-secrets/backing-up-and-restoring-kubernetes-secrets-and-configmaps.md) — Backups for K8s secrets and ConfigMaps.¹
* Kubernetes - [Helm Repo with OCI support](../kubernetes-overview/helm/oci-helm-repositories.md) — Support OCI-compliant Helm registries.¹
* Kubernetes - [Helm Release with `ValuesFrom`](../kubernetes-overview/helm/helm-charts.md) — Pull Helm chart values from external sources.¹
* Identity/Access Management - [PermissionSets user groups](../security-and-compliance/access-control-2/permission-sets.md#creating-a-user-group) — Apply PermissionSets to groups.²
* Cost Management - [Billing Alerts](../diagnostics-overview/configure-billing-alerts.md) — Configure billing alerts across AWS, Azure, and GCP.¹
* Identity/Access Management – [PermissionSet RBAC](../security-and-compliance/access-control-2/permission-sets.md#configuring-permission-sets-in-duplocloud) — Priority-based role evaluation.¹
* AWS - [EKS Taint Support](../overview/aws-services/containers/eks-containers-and-services/#creating-a-duplocloud-eks-service) — Support adding taints to EKS nodes after node creation.¹
