...
{% hint style="info" %}
You can also obtain Just-In-Time (JIT) access to Kubernetes by using `duplo-jit`. See the [JIT Access](../../../overview/use-cases/jit-access.md) documentation for detailed information about:
