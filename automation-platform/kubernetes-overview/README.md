...
DuploCloud's Advanced Observability Suite (AOS) works with all of your Kubernetes-based applications. See the [DuploCloud AOS documentation](../diagnostics-overview/advanced-observability-suite/) for details. &#x20;
