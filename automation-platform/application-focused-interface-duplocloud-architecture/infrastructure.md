...
Once an Infrastructure is created, DuploCloud automatically creates a [Plan ](plan.md)(with the same Infrastructure name) containing the Infrastructure configuration. The Plan is used to create [Tenants](../overview/use-cases/tenant-environment/).
