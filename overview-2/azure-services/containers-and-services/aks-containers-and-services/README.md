...
{% hint style="info" %}
For an end-to-end example of creating an AKS Service, see this [tutorial](../../../../automation-platform/overview-2/quick-start/).
{% endhint %}
...
15. Configure advanced options as needed. For example, you can implement [Kubernetes Lifecycle Hooks](../../../../automation-platform/kubernetes-overview/kubernetes-lifecycle-hooks.md) in the **Other Container Config** field (optional).
