...
7. Click **Add**. The Host will appear on the **ASG** tab. For information about more advanced features, such as Launch Templates, see the [Auto Scaling Groups (ASG) documentation](../../../automation-platform/overview/use-cases/hosts-vms/auto-scaling/auto-scaling-groups/).
...
4.  Click **Add**. The **Add** page displays.<br>
    ...
    <div align="left"><figure><img src="../../../.gitbook/assets/Screenshot (785).png" alt=""><figcaption><p><strong>Add</strong> page</p></figcaption></figure></div>
...
<table data-header-hidden><thead><tr><th width="180"></th><th></th></tr></thead><tbody><tr><td><strong>SSH</strong></td><td>Establish an <a href="../../../automation-platform/overview/use-cases/hosts-vms/ssh-ec2-instance.md#connecting-to-an-ec2-linux-instance-using-ssh">SSH connection</a> to work directly in the AWS Console.</td></tr><tr><td><strong>Connection Details</strong></td><td>View connection details (connection type, address, user name, visibility) and <a href="../../../automation-platform/overview/use-cases/hosts-vms/ssh-ec2-instance.md#connect-by-downloading-a-key">download the key</a>.</td></tr><tr><td><strong>Host Details</strong></td><td>View Host details in the <strong>Host Details</strong> JSON screen.</td></tr></tbody></table>
...
<table data-header-hidden><thead><tr><th width="208"></th><th></th></tr></thead><tbody><tr><td><strong>Create AMI</strong></td><td>Create an <a href="../../../automation-platform/overview/use-cases/hosts-vms/create-amazon-machine-image-ami.md">Amazon Machine Image (AMI)</a> of the Host.</td></tr><tr><td><strong>Create Snapshot</strong></td><td>Create a <a href="../../../automation-platform/overview/use-cases/hosts-vms/ec2-snapshots.md">snapshot </a>of the Host at a specific point.</td></tr><tr><td><strong>Update User Data</strong></td><td>Update the Host user data.</td></tr><tr><td><strong>Change Instance Size</strong></td><td>Resize a Host instance to accommodate the workload.</td></tr><tr><td><strong>Update Auto Reboot Status Check</strong></td><td>Enable or disable <a href="../../../automation-platform/overview/use-cases/hosts-vms/configure-auto-reboot.md">Auto Reboot</a>. Set the number of minutes after the AWS Instance Status Check fails before automatically rebooting.</td></tr></tbody></table>
