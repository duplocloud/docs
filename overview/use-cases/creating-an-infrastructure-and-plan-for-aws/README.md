...
2.  Define the Infrastructure by completing the fields:
    ...
    4. Click **Create**. The Infrastructure is created and listed on the **Infrastructure** page. DuploCloud automatically creates a [Plan ](../../../introduction/application-focused-interface-duplocloud-architecture/plan.md)(with the same Infrastructure name) with the Infrastructure configuration.&#x20;
