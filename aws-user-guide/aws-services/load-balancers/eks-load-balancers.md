...
If you need to create an Ingress Load Balancer, refer to the [EKS Ingress](../../../aws/aws-services/adding-ingress.md) page in the DuploCloud Kubernetes User Guide.&#x20;
