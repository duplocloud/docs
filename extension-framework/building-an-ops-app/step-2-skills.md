...
{% hint style="info" %}
For full skill authoring documentation — including `SKILL.md` schema, supported asset types, versioning, and skill testing — see [Skills](../introduction/ai-devops-policy-model/skills/README.md).
{% endhint %}
