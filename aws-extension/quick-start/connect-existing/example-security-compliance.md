---
description: Use DuploCloud to audit your AWS account against a compliance framework, fix failing controls, and track score improvements — without manually hunting down issues.
---
...
* A GRC tool (Vanta, Drata, or similar) is connected as a Provider. See [Integrating Providers](../../../../getting-started/integrating-providers/README.md).
