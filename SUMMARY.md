...
* [GCP User Guide](overview-1/README.md)
  ...
  * [Initial Setup](overview-1/prerequisites/README.md)
    ...
    * [\[Optional\] Docker Registry Credentials](overview-1/prerequisites/docker-registry-credentials.md)
    * [\[Optional\] Shell Access for Docker](overview-1/prerequisites/shell-access-for-docker.md)
    * [VPN Setup](overview-1/prerequisites/vpn-setup.md)
    * [Connect to the VPN](overview-1/prerequisites/connect-to-the-vpn.md)
    * [\[Optional\] Create Managed SSL Certificates for GCP](overview-1/prerequisites/create-managed-ssl-certificates-for-gcp.md)
