...
* [Kubernetes User Guide](kubernetes-overview/README.md)
  ...
  * [Kubectl](kubernetes-overview/kubectl/README.md)
    * [Kubectl Setup Guide](kubernetes-overview/kubectl/kubectl-setup/README.md)
      * [Download Kubeconfig](kubernetes-overview/kubectl/kubectl-setup/download-kubeconfig.md)
      * [Install Kubectl](kubernetes-overview/kubectl/kubectl-setup/install-kubectl.md)
      * [Configure Kubectl Shell](kubernetes-overview/kubectl/kubectl-setup/configure-kubectl-shell/README.md)
        * [Kubectl Shell for GKE](kubernetes-overview/kubectl/kubectl-setup/configure-kubectl-shell/kubectl-shell-for-gke.md)
        * [Kubectl Shell for AKS](kubernetes-overview/kubectl/kubectl-setup/configure-kubectl-shell/kubectl-shell-for-aks.md)
    * [Access the Kubectl Shell](kubernetes-overview/kubectl/access-the-kubectl-shell.md)
