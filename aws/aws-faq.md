...
No. DuploCloud segregates resources into environments called [Tenants](../getting-started/application-focussed-interface/tenant/) that accelerate ramp-up time. For more information about implementation, [contact the DuploCloud support team](https://duplocloud.com/company/contact-us/). &#x20;
