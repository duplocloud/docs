...
**Agent Platform**: This is applicable if the VM is going to be used as a host for [container orchestration](../../azure/container-deployments/) by the platform. The choices are:
