...
2. On the **Services** page, select the Service name in the **Name** column.
3. Click the **Load Balancers** tab.
4. In the **LB Listeners** card, select the Edit Icon (<img src="../../.gitbook/assets/image (3) (6).png" alt="" data-size="line">) for the Load Balancer you want to edit. The **Edit Load Balancer Listener** pane displays.
...
4. In the **Listeners** tab, in the appropriate **Target Group** row, click the **Actions** menu (<img src="../../.gitbook/assets/image (12) (3).png" alt="" data-size="line"> ) and select **Manage Rules**.
