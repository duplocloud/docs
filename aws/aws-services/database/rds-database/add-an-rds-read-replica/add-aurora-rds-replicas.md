...
3. In the **RDS** tab, click the ( <img src="../../../../../.gitbook/assets/image (12) (3).png" alt="" data-size="line"> ) icon in the **Actions** column and select **Add Replica**. The **Add Replica** pane displays.
