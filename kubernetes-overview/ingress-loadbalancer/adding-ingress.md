...
See the [Containers ](../../overview/aws-services/containers/)topic for steps on how to create [Tenants](../../welcome-to-duplocloud/duplocloud-common-components/tenant/), Hosts, and [Services](../../welcome-to-duplocloud/duplocloud-common-components/app-service-and-cloud-services.md).
