...
Before attaching certificates to an Ingress, you must add the ACM certificates to your DuploCloud Plan. For detailed instructions, see the [DuploCloud ACM documentation](../../aws-user-guide/prerequisites/acm-certificate.md#adding-an-acm-certificate-with-arn-to-a-duplocloud-plan).&#x20;
